...
(1, 7),  -- 'BIG MAC™' -> Plats préparés et Surgelés
(2, 7),  -- 'P TIT WRAP RANCH' -> Plats préparés et Surgelés
(3, 7),  -- 'CHEESEBURGER' -> Plats préparés et Surgelés
(4, 5),  -- 'McFLURRY™ SAVEUR VANILLE DAIM®' -> Pâtisseries, Desserts et Glaces
(5, 7),  -- 'Waffine à composer' -> Plats préparés et Surgelés
(6, 7),  -- 'Menu Complet' -> Plats préparés et Surgelés
(7, 11), -- 'Tropico Tropical 33cl' -> Boissons (alcoolisées et non alcoolisées)
(8, 5),  -- 'Supplément Chocolat Blanc' -> Pâtisseries, Desserts et Glaces
(9, 7),  -- 'Menu sandwich froid' -> Plats préparés et Surgelés
(10, 2), -- 'La salade PAUL' -> Fruits, Légumes et Produits frais
(11, 7), -- 'La part de pizza provençale' -> Plats préparés et Surgelés
(12, 6), -- 'Le pain nordique 300g' -> Épicerie (salée et sucrée)
(13, 5), -- 'Empanada carne' -> Pâtisseries, Desserts et Glaces
(14, 5), -- 'Empanada jamon y queso' -> Pâtisseries, Desserts et Glaces
(15, 11), -- 'Kombucha mate' -> Boissons (alcoolisées et non alcoolisées)
(16, 11), -- 'Fuzetea' -> Boissons (alcoolisées et non alcoolisées)
(17, 7),  -- '2 MENUS + 2 EXTRAS' -> Plats préparés et Surgelés
(18, 7),  -- '3 MENUS + 3 EXTRAS' -> Plats préparés et Surgelés
(19, 7),  -- 'KINGBOX 10 King Nuggets® + 10 Chili Cheese' -> Plats préparés et Surgelés
(20, 7),  -- 'Veggie Chicken Louisiane Steakhouse' -> Plats préparés et Surgelés
(21, 7),  -- 'Chicken' -> Plats préparés et Surgelés
(22, 7),  -- 'Rustic' -> Plats préparés et Surgelés
(23, 5),  -- 'Cordon Bleu' -> Pâtisseries, Desserts et Glaces
(24, 7),  -- 'Camembert Bites' -> Plats préparés et Surgelés
(25, 7),  -- 'Menu West Coast' -> Plats préparés et Surgelés
(26, 10), -- 'Mozzarella Sticks' -> Snacks, Apéritifs et Confiseries
(27, 7),  -- 'Menu KO Burger' -> Plats préparés et Surgelés
(28, 5),  -- 'Mexico' -> Pâtisseries, Desserts et Glaces
(29, 7),  -- 'Frites XL' -> Plats préparés et Surgelés
(30, 7),  -- 'Chicken ' -> Plats préparés et Surgelés
(31, 5),  -- 'Tiramisu Nutella Spéculos' -> Pâtisseries, Desserts et Glaces
(32, 7),  -- 'Farmer' -> Plats préparés et Surgelés
(33, 13), -- 'Nettoyant vitres' -> Hygiène, Beauté et Entretien
(34, 13), -- 'Carrefour Essential - Papier toilette confort doux (12)' -> Hygiène, Beauté et Entretien
(35, 4),  -- 'Kiri - Fromage enfant crème à tartiner (8)' -> Produits laitiers et Fromages
(36, 3),  -- 'Carrefour Le Marché - Viande hachée pur bœuf (350g)' -> Viandes, Poissons et Charcuterie
(37, 6),  -- 'Brioche Pasquier - Pains au lait (10)' -> Épicerie (salée et sucrée)
(38, 7),  -- 'Le Cordon Bleu' -> Plats préparés et Surgelés
(39, 7),  -- 'Le Western' -> Plats préparés et Surgelés
(40, 5),  -- 'Wings' -> Pâtisseries, Desserts et Glaces
(41, 10), -- 'Sauce Harissa' -> Sauces, Condiments et Épices
(42, 7),  -- 'Bao Poulet croustillant' -> Plats préparés et Surgelés
(43, 7),  -- 'Menu Poké & Boisson' -> Plats préparés et Surgelés
(44, 7),  -- 'Bobun boeuf' -> Plats préparés et Surgelés
(45, 7),  -- 'Beignets de crevettes tempura' -> Plats préparés et Surgelés
(46, 7),  -- 'PLAT + BOISSON CLASSIQUE' -> Plats préparés et Surgelés
(47, 7),  -- 'CRUNCHY THAÏ BOX' -> Plats préparés et Surgelés
(48, 7),  -- 'CHICKEN ou BEEF THAI' -> Plats préparés et Surgelés
(49, 7),  -- 'Le Cook Mie extra' -> Plats préparés et Surgelés
(50, 7),  -- 'Le Cook Mie Bistro' -> Plats préparés et Surgelés
(51, 6),  -- '3 Cookies Caramel achetés le 4ème offert' -> Épicerie (salée et sucrée)
(52, 6),  -- 'Cookiz duo de choc' -> Épicerie (salée et sucrée)
(53, 7),  -- 'MENU AUTHENTIQUE THON CRUDITÉS' -> Plats préparés et Surgelés
(54, 7),  -- 'TOASTÉ POULET CURRY' -> Plats préparés et Surgelés
(55, 7),  -- 'Quiche Lorraine' -> Plats préparés et Surgelés
(56, 5),  -- 'FUSETTE CITRON MERINGUÉE' -> Pâtisseries, Desserts et Glaces
(57, 5),  -- 'FROMAGE BLANC 0% FRUITS ET COULIS DE FRUITS' -> Pâtisseries, Desserts et Glaces
(58, 11), -- 'ALLONGÉ' -> Boissons (alcoolisées et non alcoolisées)
(59, 11), -- 'Pur jus de pomme Franprix 1l' -> Boissons (alcoolisées et non alcoolisées)
(60, 10), -- 'Barre chocolatée Kit Kat unité 41.5g' -> Snacks, Apéritifs et Confiseries
(61, 4),  -- 'Fromage Compté aux lait cru Franprix' -> Produits laitiers et Fromages
(62, 7),  -- '2 cuisses de canard du Sud-Ouest confites' -> Plats préparés et Surgelés
(63, 5),  -- '2 moelleux au chocolat' -> Pâtisseries, Desserts et Glaces
(64, 5),  -- 'Pizza chèvre, miel, noix' -> Pâtisseries, Desserts et Glaces
(65, 7),  -- 'Boulettes de viande kefta' -> Plats préparés et Surgelés
(66, 10), -- 'Bret s - Chips de pommes de terre, fromage (125g)' -> Snacks, Apéritifs et Confiseries
(67, 6),  -- 'Granola Choco Lait' -> Épicerie (salée et sucrée)
(68, 5),  -- 'Ben & Jerry s - Crème glacée, vanille, cookie dough (406g)' -> Pâtisseries, Desserts et Glaces
(69, 7),  -- 'Justin Bridou - Saucisson petits bâton de berger nature (100g)' -> Viandes, Poissons et Charcuterie
(70, 5),  -- 'Donut nutella billes' -> Pâtisseries, Desserts et Glaces
(71, 7),  -- 'Bagel R. Charles' -> Plats préparés et Surgelés
(72, 7),  -- 'Bagel N. Simone' -> Plats préparés et Surgelés
(73, 10), -- 'Röstis x6' -> Snacks, Apéritifs et Confiseries
(74, 7),  -- 'SUB15 Dinde' -> Plats préparés et Surgelés
(75, 7),  -- 'Wrap Crispy Avocado' -> Plats préparés et Surgelés
(76, 7),  -- 'SUB30 Xtreme Raclette Steakhouse' -> Plats préparés et Surgelés
(77, 7),  -- 'Menu SUB30 Poulet ' -> Plats préparés et Surgelés
(78, 10), -- 'Jalapenos' -> Snacks, Apéritifs et Confiseries
(79, 7),  -- 'Menu 6 HOT WINGS' -> Plats préparés et Surgelés
(80, 7),
(
   81,
   13
...
(
   1, 'Restaurant', 101, 'McDonald s', 'https://tb-static.uber.com/prod/image-proc/processed_images/2fbf5a0b7a62e385368c58d3cda5420b/30be7d11a3ed6f6183354d1933fbb6c7.jpeg', '09:00:00', '18:00:00', TRUE, FALSE
),
(
   2, 'Restaurant',102, 'Waffle Factory', 'https://tb-static.uber.com/prod/image-proc/processed_images/66ba7e9963cfdbe3126a79bd39dcf405/fb86662148be855d931b37d6c1e5fcbe.jpeg', '10:00:00', '20:00:00', FALSE, TRUE
),
(
   3, 'Épicerie',103, 'PAUL', 'https://tb-static.uber.com/prod/image-proc/processed_images/923496b75901cda79df0e9f8676a63ef/c73ecc27d2a9eaa735b1ee95304ba588.jpeg', '08:00:00', '22:00:00', TRUE, TRUE
),
(
   4, 'Restaurant',104, 'El Chaltén', 'https://tb-static.uber.com/prod/image-proc/processed_images/39c402fdde3d6556e82959a6a1875629/783282f6131ef2258e5bcd87c46aa87e.jpeg', '11:00:00', '23:00:00', FALSE, FALSE
),
(
   5, 'Restaurant',105, 'Burger King', 'https://tb-static.uber.com/prod/image-proc/processed_images/7ddafa6aaf2de203eb347fecc6104779/30be7d11a3ed6f6183354d1933fbb6c7.jpeg', '09:30:00', '19:30:00', TRUE, FALSE
),
(
   6, 'Restaurant',106, 'Street Pasta', 'https://tb-static.uber.com/prod/image-proc/processed_images/73557525500196231ccc1aa93616ed6f/3ac2b39ad528f8c8c5dc77c59abb683d.jpeg', '07:00:00', '21:00:00', FALSE, TRUE
),
(
   7, 'Restaurant',107, 'Black And White Burger', 'https://tb-static.uber.com/prod/image-proc/processed_images/73b96ac84870d9f13a58811443662dc0/c9252e6c6cd289c588c3381bc77b1dfc.jpeg', '10:00:00', '22:00:00', TRUE, FALSE
),
(
   8, 'Restaurant',108, 'Ben s Food', 'https://tb-static.uber.com/prod/image-proc/processed_images/2587cc6c5b933f5d9bc5064249bbe575/30be7d11a3ed6f6183354d1933fbb6c7.jpeg', '09:00:00', '20:00:00', TRUE, TRUE
),
(
   9, 'Épicerie',109, 'Carrefour', 'https://tb-static.uber.com/prod/image-proc/processed_images/2a4e8791c1196c02939b70b106c4c1ae/e00617ce8176680d1c4c1a6fb65963e2.png', '08:00:00', '20:00:00', FALSE, FALSE
),
(
   10, 'Restaurant',110, 'Fat Kebab', 'https://tb-static.uber.com/prod/image-proc/processed_images/c570cbbeec2420d1ccdeb75ac2d58231/c9252e6c6cd289c588c3381bc77b1dfc.jpeg', '11:00:00', '23:00:00', TRUE, FALSE
),
(
   11, 'Restaurant',111, 'Island Bowls', 'https://tb-static.uber.com/prod/image-proc/processed_images/57efbcd5e197184d730502035e58bd84/fb86662148be855d931b37d6c1e5fcbe.jpeg', '10:00:00', '00:00:00', FALSE, TRUE
),
(
   12, 'Restaurant',112, 'Pitaya', 'https://tb-static.uber.com/prod/image-proc/processed_images/40ecc6916fbbd0cd7287694a97bd1d90/3ac2b39ad528f8c8c5dc77c59abb683d.jpeg', '09:00:00', '18:00:00', TRUE, FALSE
),
(
   13, 'Épicerie',113, 'La Mie Câline', 'https://tb-static.uber.com/prod/image-proc/processed_images/6f02c35928e2bd90b78a8091edb5976f/fb86662148be855d931b37d6c1e5fcbe.jpeg', '08:30:00', '22:30:00', TRUE, TRUE
),
(
   14, 'Épicerie',114, 'Brioche Dorée', 'https://tb-static.uber.com/prod/image-proc/processed_images/23b865a8185355fdedf2ab992ec28c72/c9252e6c6cd289c588c3381bc77b1dfc.jpeg', '10:00:00', '20:00:00', FALSE, FALSE
),
(
   15, 'Épicerie',115, 'Franprix', 'https://tb-static.uber.com/prod/image-proc/processed_images/95e959904e811d23b4162516842d57f5/e00617ce8176680d1c4c1a6fb65963e2.png', '11:00:00', '23:00:00', TRUE, FALSE
),
(
   16, 'Épicerie',116, 'Picard', 'https://tb-static.uber.com/prod/image-proc/processed_images/a5b4df5effe99c1e6459b51137f07938/029e6f4e0c81c14572126109dfe867f3.png', '08:00:00', '21:00:00', TRUE, TRUE
),
(
   17, 'Épicerie',117, 'Vival', 'https://tb-static.uber.com/prod/image-proc/processed_images/7148418810e489efe27be264ba3694ec/a70f5c9df440d10213e93244e9eb7cad.jpeg', '08:00:00', '20:00:00', FALSE, FALSE
),
(
   18, 'Restaurant',118, 'Instant Rétro', 'https://tb-static.uber.com/prod/image-proc/processed_images/4be8ea88c2b77663ce2d387b2a7924aa/30be7d11a3ed6f6183354d1933fbb6c7.jpeg', '10:00:00', '22:00:00', TRUE, FALSE
),
(
   19, 'Restaurant',119, 'Chicken HOT', 'https://tb-static.uber.com/prod/image-proc/processed_images/dcdd6f59af11b38bfaba9961f80fa0ec/cc592037c936600295e9961933037e19.jpeg', '09:00:00', '18:00:00', FALSE, TRUE
),
(
   20, 'Restaurant',120, 'Subway', 'https://tb-static.uber.com/prod/image-proc/processed_images/6fc5ab9e3adaa71256b0ef5d6619159f/3ac2b39ad528f8c8c5dc77c59abb683d.jpeg', '11:00:00', '23:00:00', TRUE, TRUE
);
...
(81, 'Shampooing L’Oréal 250ml', 4.99, 'https://example.com/shampooing.jpg', 'Shampooing nourrissant pour cheveux secs'),
(82, 'Gel Douche Dove 500ml', 3.50, 'https://example.com/gel-douche.jpg', 'Gel douche hydratant pour une peau douce'),
(83, 'Papier Aluminium 30m', 2.99, 'https://example.com/papier-aluminium.jpg', 'Rouleau de papier aluminium pour usage domestique'),
(84, 'Brosse à dents Oral-B', 2.75, 'https://example.com/brosse-a-dents.jpg', 'Brosse à dents avec brins souples pour un nettoyage en profondeur'),
(85, 'Savon Liquide Dettol 250ml', 3.20, 'https://example.com/savon-liquide.jpg', 'Savon liquide antibactérien pour les mains'),
(86, 'Pack de 6 bouteilles d’eau Evian 1.5L', 6.00, 'https://example.com/eau-evian.jpg', 'Eau minérale naturelle en pack pratique'),
(87, 'Lessive Ariel 3kg', 12.99, 'https://example.com/lessive-ariel.jpg', 'Lessive en poudre pour un linge impeccable'),
(88, 'Boîte de mouchoirs en papier', 1.80, 'https://example.com/mouchoirs.jpg', 'Mouchoirs en papier doux et résistants'),
(89, 'Batteries AA Duracell (pack de 4)', 6.50, 'https://example.com/batteries.jpg', 'Piles longue durée pour appareils électroniques'),
(90, 'Ampoule LED 10W Philips', 5.99, 'https://example.com/ampoule-led.jpg', 'Ampoule LED écoénergétique, équivalente à 60W'),
(91, 'Crème hydratante Nivea 200ml', 7.50, 'https://example.com/creme-nivea.jpg', 'Crème nourrissante pour une peau douce et hydratée'),
(92, 'Ruban adhésif Scotch 50m', 1.99, 'https://example.com/ruban-adhesif.jpg', 'Ruban adhésif transparent pour usage quotidien'),
(93, 'Ciseaux Fiskars', 8.00, 'https://example.com/ciseaux.jpg', 'Ciseaux robustes et ergonomiques pour travaux de coupe'),
(94, 'Cahier Oxford 200 pages', 3.25, 'https://example.com/cahier-oxford.jpg', 'Cahier grand format avec couverture rigide'),
(95, 'Pack de 3 éponges Scotch-Brite', 2.49, 'https://example.com/eponges.jpg', 'Éponges résistantes pour nettoyage en profondeur'),
(96, 'Spray nettoyant multisurface Ajax 750ml', 3.99, 'https://example.com/spray-nettoyant.jpg', 'Spray nettoyant pour toutes les surfaces'),
(97, 'Sac poubelle 50L (10 unités)', 2.75, 'https://example.com/sac-poubelle.jpg', 'Sacs poubelle résistants avec liens intégrés'),
(98, 'Coton-tiges Johnson & Johnson (200 unités)', 1.90, 'https://example.com/coton-tiges.jpg', 'Coton-tiges doux et pratiques pour une hygiène quotidienne'),
(99, 'Thermomètre digital Omron', 12.90, 'https://example.com/thermometre.jpg', 'Thermomètre précis pour mesure rapide de la température'),
(100, 'Pack de feuilles A4 500 pages', 4.99, 'https://example.com/feuilles-a4.jpg', 'Papier pour imprimante et usage bureautique');
...
) VALUES (1, 'Courses', 'Livraison de courses et produits', 'courses.jpg'),
(2, 'Halal', 'Restaurants et plats halal', 'halal.jpg'),
(3, 'Pizzas', 'Livraison de pizzas', 'pizzas.jpg'),
(4, 'Sushis', 'Restaurants et livraison de sushis', 'sushis.jpg'),
(5, 'Alcool', 'Livraison de boissons alcoolisées', 'alcool.jpg'),
(6, 'Épicerie', 'Produits d épicerie', 'epicerie.jpg'),
(7, 'Fast food', 'Restauration rapide', 'fastfood.jpg'),
(8, 'Burgers', 'Restaurants de burgers', 'burgers.jpg'),
(9, 'Asiatique', 'Cuisine asiatique', 'asiatique.jpg'),
(10, 'Cuisine saine', 'Options de repas santé', 'cuisinesaine.jpg'),
(11, 'Thaïlandaise', 'Cuisine thaïlandaise', 'thailandaise.jpg'),
(12, 'Coréenne', 'Cuisine coréenne', 'coreenne.jpg'),
(13, 'Indienne', 'Cuisine indienne', 'indienne.jpg'),
(14, 'Thé aux perles', 'Bubble tea', 'teauxperles.jpg'),
(15, 'Ailes de poulet', 'Spécialités de poulet', 'ailespoule.jpg'),
(16, 'Boulangerie', 'Produits de boulangerie', 'boulangerie.jpg'),
(17, 'Casher', 'Restaurants et plats casher', 'casher.jpg'),
(18, 'Chinoise', 'Cuisine chinoise', 'chinoise.jpg'),
(19, 'Poke (poisson cru)', 'Bols de poisson cru', 'poke.jpg'),
(20, 'Mexicaine', 'Cuisine mexicaine', 'mexicaine.jpg'),
(21, 'Sandwich', 'Sandwichs et paninis', 'sandwich.jpg'),
(22, 'Italienne', 'Cuisine italienne', 'italienne.jpg'),
(23, 'Barbecue', 'Restaurants de barbecue', 'barbecue.jpg'),
(24, 'Spécialité', 'Plats et cuisines spécialisés', 'specialite.jpg'),
(25, 'Petit-déjeuner', 'Options de petit-déjeuner', 'petitdejeuner.jpg'),
(26, 'Vegan', 'Options végétaliennes', 'vegan.jpg'),
(27, 'Caribéenne', 'Cuisine caribéenne', 'caribeenne.jpg'),
(28, 'Parapharmacie', 'Produits paramédicaux', 'parapharmacie.jpg'),
(29, 'Fleurs', 'Livraison de fleurs', 'fleurs.jpg'),
(30, 'Japonaise', 'Cuisine japonaise', 'japonaise.jpg'),
(31, 'Vietnamienne', 'Cuisine vietnamienne', 'vietnamienne.jpg'),
(32, 'Fruits de mer', 'Restaurants de fruits de mer', 'fruitsmer.jpg'),
(33, 'Soupes', 'Restaurants de soupes', 'soupes.jpg'),
(34, 'Américaine', 'Cuisine américaine', 'americaine.jpg'),
(35, 'Café', 'Cafés et boissons chaudes', 'cafe.jpg'),
(36, 'Hygiène', 'Produits d hygiène', 'hygiene.jpg'),
(37, 'Afro américaine', 'Cuisine afro-américaine', 'afroamericaine.jpg'),
(38, 'Boutique', 'Produits de boutique', 'boutique.jpg'),
(39, 'Glaces', 'Crèmes glacées et desserts glacés', 'glaces.jpg'),
(40, 'Grecque', 'Cuisine grecque', 'grecque.jpg'),
(41, 'Street food', 'Cuisine de rue', 'streetfood.jpg'),
(42, 'Repas détente', 'Restaurants décontractés', 'repasdetente.jpg'),
(43, 'Smoothies', 'Boissons smoothies', 'smoothies.jpg'),
(44, 'Articles pour animaux', 'Produits et accessoires pour animaux', 'animaux.jpg'),
(45, 'Hawaïenne', 'Cuisine hawaïenne', 'hawaienne.jpg'),
(46, 'Taïwanaise', 'Cuisine taïwanaise', 'taiwanaise.jpg');
...
---------------------------------------------------------------
ALTER TABLE ADRESSE
   ADD CONSTRAINT FK_ADRESSE_EST_DANS_VILLE FOREIGN KEY (IDVILLE)
      REFERENCES VILLE (IDVILLE) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE APPARTIENT_2
   ADD CONSTRAINT FK_APPARTIENT2_CARTE_BANCAIRE FOREIGN KEY (IDCB)
      REFERENCES CARTE_BANCAIRE (IDCB) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE APPARTIENT_2
   ADD CONSTRAINT FK_APPARTIENT2_CLIENT FOREIGN KEY (IDCLIENT)
      REFERENCES CLIENT (IDCLIENT) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE A_3
   ADD CONSTRAINT FK_A_3_PRODUIT FOREIGN KEY (IDPRODUIT)
      REFERENCES PRODUIT (IDPRODUIT) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE A_3
   ADD CONSTRAINT FK_A_3_CATEGORIE_PRODUIT FOREIGN KEY (IDCATEGORIE)
      REFERENCES CATEGORIE_PRODUIT (IDCATEGORIE) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE A_COMME_TYPE
   ADD CONSTRAINT FK_A_COMME_TYPE_VEHICULE FOREIGN KEY (IDVEHICULE)
      REFERENCES VEHICULE (IDVEHICULE) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE A_COMME_TYPE
   ADD CONSTRAINT FK_A_COMME_TYPE_PRESTATION FOREIGN KEY (IDPRESTATION)
      REFERENCES TYPE_PRESTATION (IDPRESTATION) ON DELETE RESTRICT ON UPDATE RESTRICT;


ALTER TABLE CLIENT
   ADD CONSTRAINT FK_CLIENT_PLANNING FOREIGN KEY (IDPLANNING)
      REFERENCES PLANNING_RESERVATION (IDPLANNING) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE CLIENT
   ADD CONSTRAINT FK_CLIENT_PANIER FOREIGN KEY (IDPANIER)
      REFERENCES PANIER (IDPANIER) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE CLIENT
   ADD CONSTRAINT FK_CLIENT_ENTREPRISE FOREIGN KEY (IDENTREPRISE)
      REFERENCES ENTREPRISE (IDENTREPRISE) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE CLIENT
   ADD CONSTRAINT FK_CLIENT_ADRESSE FOREIGN KEY (IDADRESSE)
      REFERENCES ADRESSE (IDADRESSE) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE CODE_POSTAL
   ADD CONSTRAINT FK_CODE_POSTAL_PAYS FOREIGN KEY (IDPAYS)
      REFERENCES PAYS (IDPAYS) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE COMMANDE
   ADD CONSTRAINT FK_COMMANDE_COURSIER FOREIGN KEY (IDCOURSIER)
      REFERENCES COURSIER (IDCOURSIER) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE COMMANDE
   ADD CONSTRAINT FK_COMMANDE_PANIER FOREIGN KEY (IDPANIER)
      REFERENCES PANIER (IDPANIER) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE CONTIENT_2
   ADD CONSTRAINT FK_CONTIENT2_PANIER FOREIGN KEY (IDPANIER)
      REFERENCES PANIER (IDPANIER) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE CONTIENT_2
   ADD CONSTRAINT FK_CONTIENT2_PRODUIT FOREIGN KEY (IDPRODUIT)
      REFERENCES PRODUIT (IDPRODUIT) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE COURSE
   ADD CONSTRAINT FK_COURSE_PRESTATION FOREIGN KEY (IDPRESTATION)
      REFERENCES TYPE_PRESTATION (IDPRESTATION) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE COURSE
   ADD CONSTRAINT FK_COURSE_ADRESSE_START FOREIGN KEY (ADR_IDADRESSE)
      REFERENCES ADRESSE (IDADRESSE) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE COURSE
   ADD CONSTRAINT FK_COURSE_RESERVATION FOREIGN KEY (IDRESERVATION)
      REFERENCES RESERVATION (IDRESERVATION) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE COURSE
   ADD CONSTRAINT FK_COURSE_ADRESSE_END FOREIGN KEY (IDADRESSE)
      REFERENCES ADRESSE (IDADRESSE) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE COURSE
   ADD CONSTRAINT FK_COURSE_CARTE_BANCAIRE FOREIGN KEY (IDCB)
      REFERENCES CARTE_BANCAIRE (IDCB) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE COURSE
   ADD CONSTRAINT FK_COURSE_PAR_COURSIER FOREIGN KEY (IDCOURSIER)
      REFERENCES COURSIER (IDCOURSIER) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE COURSIER
   ADD CONSTRAINT FK_COURSIER_ENTREPRISE FOREIGN KEY (IDENTREPRISE)
      REFERENCES ENTREPRISE (IDENTREPRISE) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE COURSIER
   ADD CONSTRAINT FK_COURSIER_ADRESSE FOREIGN KEY (IDADRESSE)
      REFERENCES ADRESSE (IDADRESSE) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE DEPARTEMENT
   ADD CONSTRAINT FK_DEPARTEMENT_PAYS FOREIGN KEY (IDPAYS)
      REFERENCES PAYS (IDPAYS) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE ENTREPRISE
   ADD CONSTRAINT FK_ENTREPRISE_CLIENT FOREIGN KEY (IDCLIENT)
      REFERENCES CLIENT (IDCLIENT) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE ENTREPRISE
   ADD CONSTRAINT FK_ENTREPRISE_ADRESSE FOREIGN KEY (IDADRESSE)
      REFERENCES ADRESSE (IDADRESSE) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE EST_SITUE_A_2
   ADD CONSTRAINT FK_EST_SITUE2_PRODUIT FOREIGN KEY (IDPRODUIT)
      REFERENCES PRODUIT (IDPRODUIT) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE EST_SITUE_A_2
   ADD CONSTRAINT FK_EST_SITUE2_ETABLISSEMENT FOREIGN KEY (IDETABLISSEMENT)
      REFERENCES ETABLISSEMENT (IDETABLISSEMENT) ON DELETE RESTRICT ON UPDATE RESTRICT;



   ALTER TABLE A_COMME_CATEGORIE
ADD CONSTRAINT FK_A_COMME_CATEGORIE_PRESTATIONC FOREIGN KEY (IDCATEGORIEPRESTATION)
   REFERENCES CATEGORIE_PRESTATION (IDCATEGORIEPRESTATION) ON DELETE RESTRICT ON UPDATE RESTRICT;


   ALTER TABLE A_COMME_CATEGORIE
ADD CONSTRAINT FK_COMME_CATEGORIE_ETABLISSEMENT FOREIGN KEY (IDETABLISSEMENT)
   REFERENCES ETABLISSEMENT (IDETABLISSEMENT) ON DELETE RESTRICT ON UPDATE RESTRICT;



ALTER TABLE ETABLISSEMENT
   ADD CONSTRAINT FK_ETABLISSEMENT_ADRESSE FOREIGN KEY (IDADRESSE)
      REFERENCES ADRESSE (IDADRESSE) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE FACTURE_COURSE
   ADD CONSTRAINT FK_FACTURE_COURSE FOREIGN KEY (IDCOURSE)
      REFERENCES COURSE (IDCOURSE) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE FACTURE_COURSE
   ADD CONSTRAINT FK_FACTURE_CLIENT FOREIGN KEY (IDCLIENT)
      REFERENCES CLIENT (IDCLIENT) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE FACTURE_COURSE
   ADD CONSTRAINT FK_FACTURE_PAYS FOREIGN KEY (IDPAYS)
      REFERENCES PAYS (IDPAYS) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE PANIER
   ADD CONSTRAINT FK_PANIER_CLIENT FOREIGN KEY (IDCLIENT)
      REFERENCES CLIENT (IDCLIENT) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE PLANNING_RESERVATION
   ADD CONSTRAINT FK_PLANNING_CLIENT FOREIGN KEY (IDCLIENT)
      REFERENCES CLIENT (IDCLIENT) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE REGLEMENT_SALAIRE
   ADD CONSTRAINT FK_REGLEMENT_COURSIER FOREIGN KEY (IDCOURSIER)
      REFERENCES COURSIER (IDCOURSIER) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE RESERVATION
   ADD CONSTRAINT FK_RESERVATION_PLANNING FOREIGN KEY (IDPLANNING)
      REFERENCES PLANNING_RESERVATION (IDPLANNING) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE RESERVATION
   ADD CONSTRAINT FK_RESERVATION_VELO FOREIGN KEY (IDVELO)
      REFERENCES VELO (IDVELO) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE RESERVATION
   ADD CONSTRAINT FK_RESERVATION_CLIENT FOREIGN KEY (IDCLIENT)
      REFERENCES CLIENT (IDCLIENT) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE VEHICULE
   ADD CONSTRAINT FK_VEHICULE_COURSIER FOREIGN KEY (IDCOURSIER)
      REFERENCES COURSIER (IDCOURSIER) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE VELO
   ADD CONSTRAINT FK_VELO_ADRESSE FOREIGN KEY (IDADRESSE)
      REFERENCES ADRESSE (IDADRESSE) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE VILLE
   ADD CONSTRAINT FK_VILLE_CODE_POSTAL FOREIGN KEY (IDCODEPOSTAL)
      REFERENCES CODE_POSTAL (IDCODEPOSTAL) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE VILLE
   ADD CONSTRAINT FK_VILLE_PAYS FOREIGN KEY (IDPAYS)
      REFERENCES PAYS (IDPAYS) ON DELETE RESTRICT ON UPDATE RESTRICT;